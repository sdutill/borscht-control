...
#define double sqlite3_int64
  ...
  ** statements, BLOB handlers, and/or unfinished sqlit3e_backup objects then
...
#define SQLITE_DBCONFIG_MAX 1019                   /* Largest DBCONFIG */
  ...
  **
  ** ^The [sqlite3_is_interrupted(D)] interface can be used to determine
  *whether
...
#define SQLITE_PREPARE_NO_VTAB 0x04
  ...
  */
  ...
  SQLITE_API int
  sqlite3_prepare16_v3(sqlite3 *db,            /* Database handle */
                       const void *zSql,       /* SQL statement, UTF-16 encoded */
                       int nByte,              /* Maximum length of zSql in bytes. */
                       unsigned int prepFlags, /* Zero or more SQLITE_PREPARE_ flags */
                       sqlite3_stmt **ppStmt,  /* OUT: Statement handle */
...
#define SQLITE3_TEXT 3
  ...
  */
  SQLITE_API int
  sqlite3_create_function(sqlite3 *db, const char *zFunctionName, int nArg, int eTextRep,
                          void *pApp, void (*xFunc)(sqlite3_context *, int, sqlite3_value **),
                          void (*xStep)(sqlite3_context *, int, sqlite3_value **),
                          void (*xFinal)(sqlite3_context *));
  SQLITE_API int
  sqlite3_create_function16(sqlite3 *db, const void *zFunctionName, int nArg, int eTextRep,
                            void *pApp, void (*xFunc)(sqlite3_context *, int, sqlite3_value **),
                            void (*xStep)(sqlite3_context *, int, sqlite3_value **),
                            void (*xFinal)(sqlite3_context *));
  SQLITE_API int
  sqlite3_create_function_v2(sqlite3 *db, const char *zFunctionName, int nArg, int eTextRep,
                             void *pApp, void (*xFunc)(sqlite3_context *, int, sqlite3_value **),
                             void (*xStep)(sqlite3_context *, int, sqlite3_value **),
...
*/
  ...
  ** encoding argument when the function is
  *[sqlite3_create_function|registered].
...
#define SQLITE_TRANSIENT ((sqlite3_destructor_type) - 1)
  ...
  */
  ...
  SQLITE_API void
  sqlite3_result_blob64(sqlite3_context *, const void *, sqlite3_uint64, void (*)(void *));
  ...
  ** an error.  Future versions of SQLite might enable
  ...
  */
  SQLITE_API int
  sqlite3_create_collation(sqlite3 *, const char *zName, int eTextRep, void *pArg,
                           int (*xCompare)(void *, int, const void *, int, const void *));
  SQLITE_API int
  sqlite3_create_collation_v2(sqlite3 *, const char *zName, int eTextRep, void *pArg,
                              int (*xCompare)(void *, int, const void *, int, const void *),
                              void (*xDestroy)(void *));
  SQLITE_API int
  sqlite3_create_collation16(sqlite3 *, const void *zName, int eTextRep, void *pArg,
                             int (*xCompare)(void *, int, const void *, int, const void *));
...
#define SQLITE_INDEX_CONSTRAINT_FUNCTION 150
  ...
  */
  SQLITE_API int
  sqlite3_blob_open(sqlite3 *, const char *zDb, const char *zTable, const char *zColumn,
...
#define SQLITE_TESTCTRL_LAST 34          /* Largest TESTCTRL */
  ...
  **
  ** The sqlite3_keyword_name(N,Z,L) interface finds the 0-based N-th keyword
  *and
  ...
  */
  ...
  SQLITE_API int
  sqlite3_status64(int op, sqlite3_int64 *pCurrent, sqlite3_int64 *pHighwater, int resetFlag);
...
#define SQLITE_STMTSTATUS_MEMUSED 99
  ...
  */
  SQLITE_API int
  sqlite3_wal_checkpoint_v2(sqlite3 *db,     /* Database handle */
...
#define SQLITE_SESSION_OBJCONFIG_ROWID 2
  ...
  */
  SQLITE_API int
  sqlite3session_changeset(sqlite3_session *pSession, /* Session object */
...
#define SQLITE_CHANGESETSTART_INVERT 0x0002
  ...
  */
  SQLITE_API int
  sqlite3changeset_fk_conflicts(sqlite3_changeset_iter *pIter, /* Changeset iterator */
...
#define SQLITE_CHANGESET_ABORT 2
  ...
  */
  SQLITE_API int
  sqlite3rebaser_rebase(sqlite3_rebaser *, int nIn, const void *pIn, int *pnOut, void **ppOut);
  ...
  */
  ...
  sqlite3changeset_invert_strm(int (*xInput)(void *pIn, void *pData, int *pnData), void *pIn,
                               ...
                               void *pOut);
  SQLITE_API int
  sqlite3changeset_start_strm(sqlite3_changeset_iter **pp,
  ...
  sqlite3session_patchset_strm(sqlite3_session *pSession,
                               ...
                               void *pOut);
  SQLITE_API int
  sqlite3changegroup_add_strm(sqlite3_changegroup *,
                              int (*xInput)(void *pIn, void *pData, int *pnData), void *pIn);
  SQLITE_API int
  sqlite3changegroup_output_strm(sqlite3_changegroup *,
                                 int (*xOutput)(void *pOut, const void *pData, int nData),
                                 void *pOut);
  SQLITE_API int
  sqlite3rebaser_rebase_strm(sqlite3_rebaser *pRebaser,
                             int (*xInput)(void *pIn, void *pData, int *pnData), void *pIn,
